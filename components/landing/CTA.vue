		...
		<div
			...
			<div
				...
				<h2
					...
					Come join us!<br />Sign up today, free forever
				</h2>
				<p class="mt-6 text-lg leading-8 text-gray-300">
					Join our free services today, and start having fun with us!
				</p>
				<div
					...
					<a
						href="#"
						class="text-sm font-semibold group leading-6 text-white"
			...
			<div class="relative mt-16 h-80 lg:mt-8">
				<img
					...
					src="/images/assets/screenshots/screenshot2.png"
					alt="App screenshot"
					width="1824"
					height="1080" />
			</div>
